...
namespace Fitbit.Portable.Tests
{
    ...
    public class FitbitClientHelperExtensionsTests
    {
        ...
        {
            string apiCall = FitbitClientHelperExtensions.ToFullUrl("1/user/{0}/friends.json");
        ...
        {
            string apiCall = FitbitClientHelperExtensions.ToFullUrl("1/user/{0}/friends.json", "2KNXXX");
